acquisition_values = {
    ...
    "peak_sample_offset": "Energy filter sampling time measured backward from the peaking time and gap time, specified in us.Effectively sets PEAKSAM= SLOWLEN + SLOWGAP - peak_sample_offset. Added in v1.2.2.",
    ...
    "peak_sample": "[Deprecated] The value of PEAKSAM, specified in us. Deprecated in v1.2.2, use peak_sample_offset instead.",
    # Detector
