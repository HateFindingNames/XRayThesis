\chapter{Software}
    ...
    \section{Motion System}
        ...
        Since reproducing that functionality is a non-trivial task and the orchestrating system is \textit{Raspberry Pi} based, the popular 3D-printer firmware \textit{Klipper}~\cite{Software.Klipper.2023} was chosen to generate the stepping pulses.
